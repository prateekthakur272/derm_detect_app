...
const title = 'Derm Detect';
const intro = 'Innovating Skin Wellness\nThrough Detection';
const introSubtitle = 'Fast, Accurate, And Secure';

 // Colors
 const primaryColor = Color.fromARGB(255, 9, 108, 147);
